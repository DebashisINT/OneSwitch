package com.oneswitch.features.dashboard.presentation
...
import com.oneswitch.app.domain.*
import com.oneswitch.app.types.DashboardType
import com.oneswitch.app.types.FragType
import com.oneswitch.app.types.TopBarConfig
import com.oneswitch.app.uiaction.DisplayAlert
import com.oneswitch.app.utils.*
import com.oneswitch.app.utils.AppUtils.Companion.isProfile
import com.oneswitch.base.BaseResponse
import com.oneswitch.base.presentation.BaseActivity
import com.oneswitch.base.presentation.BaseFragment
import com.oneswitch.features.NewQuotation.AddQuotFormFragment
import com.oneswitch.features.NewQuotation.ViewAllQuotListFragment
import com.oneswitch.features.NewQuotation.ViewDetailsQuotFragment
import com.oneswitch.features.SearchLocation.SearchLocationFragment
import com.oneswitch.features.SearchLocation.locationInfoModel
import com.oneswitch.features.TA.ViewAllTAListFragment
import com.oneswitch.features.achievement.AchievementFragment
import com.oneswitch.features.activities.presentation.*
import com.oneswitch.features.addAttendence.*
import com.oneswitch.features.addAttendence.model.Leave_list_Response
import com.oneswitch.features.addorder.presentation.AddOrderFragment
...
import com.oneswitch.features.addshop.presentation.AddShopFragment
import com.oneswitch.features.addshop.presentation.OTPVerificationDialog
import com.oneswitch.features.addshop.presentation.ScanImageFragment
import com.oneswitch.features.addshop.presentation.ShowCardDetailsDialog
import com.oneswitch.features.alarm.model.AlarmData
import com.oneswitch.features.alarm.presetation.AttendanceReportFragment
import com.oneswitch.features.alarm.presetation.PerformanceReportFragment
import com.oneswitch.features.alarm.presetation.VisitReportDetailsFragment
import com.oneswitch.features.alarm.presetation.VisitReportFragment
import com.oneswitch.features.attendance.AttendanceFragment
import com.oneswitch.features.attendance.api.AttendanceRepositoryProvider
...
import com.oneswitch.features.averageshop.presentation.AverageShopFragment
import com.oneswitch.features.avgorder.presentation.AverageOrderFragment
import com.oneswitch.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.oneswitch.features.billing.presentation.AddBillingFragment
import com.oneswitch.features.billing.presentation.BillingDetailsFragment
import com.oneswitch.features.billing.presentation.BillingListFragment
import com.oneswitch.features.changepassword.presentation.ChangePasswordDialog
import com.oneswitch.features.chat.model.ChatListDataModel
import com.oneswitch.features.chat.model.ChatUserDataModel
import com.oneswitch.features.chat.model.GroupUserDataModel
import com.oneswitch.features.chat.presentation.*
import com.oneswitch.features.chatbot.presentation.ChatBotFragment
import com.oneswitch.features.chatbot.presentation.ChatBotShopListFragment
import com.oneswitch.features.chatbot.presentation.ReportsFragment
import com.oneswitch.features.chatbot.presentation.SelectLanguageDialog
import com.oneswitch.features.commondialog.presentation.CommonDialog
import com.oneswitch.features.commondialog.presentation.CommonDialogClickListener
import com.oneswitch.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.oneswitch.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.oneswitch.features.commondialogsinglebtn.OnDialogClickListener
import com.oneswitch.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.oneswitch.features.dailyPlan.prsentation.AllShopListFragment
import com.oneswitch.features.dailyPlan.prsentation.DailyPlanListFragment
import com.oneswitch.features.dailyPlan.prsentation.PlanDetailsFragment
import com.oneswitch.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.oneswitch.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.oneswitch.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.oneswitch.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.oneswitch.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.oneswitch.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.oneswitch.features.dashboard.presentation.model.ContentListResponseModel
import com.oneswitch.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.oneswitch.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.oneswitch.features.device_info.presentation.DeviceInfoListFragment
import com.oneswitch.features.document.DocumentRepoFeatureNewFragment
import com.oneswitch.features.document.presentation.DocumentListFragment
import com.oneswitch.features.document.presentation.DocumentTypeListFragment
import com.oneswitch.features.document.presentation.OpenFileWebViewFragment
import com.oneswitch.features.dymanicSection.presentation.AddDynamicFragment
import com.oneswitch.features.dymanicSection.presentation.AllDynamicListFragment
import com.oneswitch.features.dymanicSection.presentation.DynamicListFragment
import com.oneswitch.features.dymanicSection.presentation.EditDynamicFragment
import com.oneswitch.features.gpsDisabilityScreen.GpsDisableFragment
import com.oneswitch.features.home.presentation.HomeFragment
import com.oneswitch.features.homelocation.presentation.HomeLocationFragment
import com.oneswitch.features.homelocation.presentation.HomeLocationMapFragment
import com.oneswitch.features.know_your_state.KnowYourStateFragment
import com.oneswitch.features.lead.LeadFrag
import com.oneswitch.features.lead.ViewLeadFrag
import com.oneswitch.features.leaveapplynew.LeaveHome
import com.oneswitch.features.localshops.LocalShopListFragment
import com.oneswitch.features.localshops.LocalShopListMapFragment
import com.oneswitch.features.localshops.NearByShopsMapFragment
import com.oneswitch.features.location.*
import com.oneswitch.features.login.ShopFeedbackEntity
import com.oneswitch.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.oneswitch.features.login.presentation.LoginActivity
import com.oneswitch.features.logout.presentation.api.LogoutRepositoryProvider
import com.oneswitch.features.logoutsync.presentation.LogoutSyncFragment
import com.oneswitch.features.marketing.presentation.MarketingPagerFragment
import com.oneswitch.features.meetinglist.prsentation.MeetingListFragment
import com.oneswitch.features.member.model.TeamLocDataModel
import com.oneswitch.features.member.model.TeamShopListDataModel
import com.oneswitch.features.member.presentation.*
import com.oneswitch.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.oneswitch.features.micro_learning.presentation.MicroLearningListFragment
import com.oneswitch.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.oneswitch.features.myallowancerequest.MyallowanceRequestFragment
import com.oneswitch.features.myjobs.model.CustomerDataModel
import com.oneswitch.features.myjobs.presentation.*
import com.oneswitch.features.myorder.presentation.MyOrderListFragment
import com.oneswitch.features.myprofile.presentation.MyProfileFragment
import com.oneswitch.features.nearbyshops.presentation.BeatListFragment
import com.oneswitch.features.nearbyshops.presentation.NearByShopsListFragment
import com.oneswitch.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.oneswitch.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.oneswitch.features.newcollection.CollectionDetailsStatusFragment
import com.oneswitch.features.newcollection.CollectionShopListFragment
import com.oneswitch.features.newcollection.NewCollectionListFragment
import com.oneswitch.features.notification.NotificationFragment
import com.oneswitch.features.orderList.NewDateWiseOrderListFragment
import com.oneswitch.features.orderList.NewOrderListFragment
import com.oneswitch.features.orderList.OrderListFragment
import com.oneswitch.features.orderdetail.presentation.OrderDetailFragment
import com.oneswitch.features.orderhistory.ActivityMapFragment
import com.oneswitch.features.orderhistory.OrderhistoryFragment
import com.oneswitch.features.orderhistory.TimeLineFragment
import com.oneswitch.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.oneswitch.features.orderhistory.model.LocationData
import com.oneswitch.features.performance.GpsStatusFragment
import com.oneswitch.features.performance.PerformanceFragment
import com.oneswitch.features.performance.api.UpdateGpsStatusRepoProvider
import com.oneswitch.features.performance.model.UpdateGpsInputParamsModel
import com.oneswitch.features.permissionList.ViewPermissionFragment
import com.oneswitch.features.photoReg.PhotoAttendanceFragment
import com.oneswitch.features.photoReg.ProtoRegistrationFragment
import com.oneswitch.features.photoReg.RegisTerFaceFragment
import com.oneswitch.features.photoReg.TeamAttendanceFragment
import com.oneswitch.features.quotation.presentation.*
import com.oneswitch.features.reimbursement.presentation.EditReimbursementFragment
import com.oneswitch.features.reimbursement.presentation.ReimbursementDetailsFragment
import com.oneswitch.features.reimbursement.presentation.ReimbursementFragment
import com.oneswitch.features.reimbursement.presentation.ReimbursementListFragment
import com.oneswitch.features.report.presentation.*
import com.oneswitch.features.returnsOrder.*
import com.oneswitch.features.settings.presentation.SettingsFragment
import com.oneswitch.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.oneswitch.features.shopdetail.presentation.*
import com.oneswitch.features.shopdetail.presentation.api.EditShopRepoProvider
import com.oneswitch.features.stock.StockDetailsFragment
import com.oneswitch.features.stock.StockListFragment
import com.oneswitch.features.stockAddCurrentStock.AddShopStockFragment
import com.oneswitch.features.stockAddCurrentStock.UpdateShopStockFragment
import com.oneswitch.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.oneswitch.features.stockCompetetorStock.AddCompetetorStockFragment
import com.oneswitch.features.stockCompetetorStock.CompetetorStockFragment
import com.oneswitch.features.stockCompetetorStock.ViewComStockProductDetails
import com.oneswitch.features.task.presentation.AddTaskFragment
import com.oneswitch.features.task.presentation.CalenderTaskFragment
import com.oneswitch.features.task.presentation.EditTaskFragment
import com.oneswitch.features.task.presentation.TaskListFragment
import com.oneswitch.features.timesheet.presentation.AddTimeSheetFragment
import com.oneswitch.features.timesheet.presentation.EditTimeSheetFragment
import com.oneswitch.features.timesheet.presentation.TimeSheetListFragment
import com.oneswitch.features.viewAllOrder.CartFragment
import com.oneswitch.features.viewAllOrder.OrderTypeListFragment
import com.oneswitch.features.viewAllOrder.ViewAllOrderListFragment
import com.oneswitch.features.viewAllOrder.ViewCartFragment
import com.oneswitch.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.oneswitch.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.oneswitch.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.oneswitch.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.oneswitch.features.viewPPDDStock.ViewOutstandingFragment
import com.oneswitch.features.viewPPDDStock.ViewPPDDListFragment
import com.oneswitch.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.oneswitch.features.viewPPDDStock.ViewStockFragment
import com.oneswitch.features.weather.presentation.WeatherFragment
import com.oneswitch.mappackage.MapActivity
import com.oneswitch.mappackage.MapActivityWithoutPath
import com.oneswitch.widgets.AppCustomEditText
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xoneswitchlogsample/log").path);
            //27-09-2021
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xoneswitchlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xoneswitchlogsample/log.bak.1").path);
