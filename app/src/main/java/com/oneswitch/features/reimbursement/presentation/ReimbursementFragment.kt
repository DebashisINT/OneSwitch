...
import com.oneswitch.app.utils.AppUtils.Companion.convertFromRightToReverseFormatWithTime
import com.oneswitch.app.utils.AppUtils.Companion.getFormattedDateForApi
import com.oneswitch.app.utils.AppUtils.Companion.hideSoftKeyboard
...
class ReimbursementFragment : BaseFragment(), DateAdapter.onPetSelectedListener, View.OnClickListener, TabLayout.OnTabSelectedListener, RadioGroup.OnCheckedChangeListener {
    ...
    private fun attachoneswitchData() {
