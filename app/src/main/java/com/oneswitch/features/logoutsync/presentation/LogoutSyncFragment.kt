package com.oneswitch.features.logoutsync.presentation
...
import com.oneswitch.app.utils.AppUtils
import com.oneswitch.app.utils.Toaster
import com.oneswitch.base.BaseResponse
import com.oneswitch.base.presentation.BaseActivity
import com.oneswitch.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.oneswitch.features.addshop.api.AddShopRepositoryProvider
import com.oneswitch.features.billing.api.AddBillingRepoProvider
import com.oneswitch.features.billing.model.AddBillingInputParamsModel
...
import com.oneswitch.features.dashboard.presentation.ReasonDialog
...
import com.oneswitch.features.document.model.AddEditDocumentInputParams
import com.oneswitch.features.document.model.DocumentAttachmentModel
...
import com.oneswitch.features.location.model.*
import com.oneswitch.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
...
import com.oneswitch.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.oneswitch.features.nearbyshops.model.updateaddress.AddressUpdateRequest
...
import com.oneswitch.features.quotation.model.AddQuotInputModel
import com.oneswitch.features.shopdetail.presentation.api.EditShopRepoProvider
import com.oneswitch.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.oneswitch.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.oneswitch.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.oneswitch.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.oneswitch.features.timesheet.model.AddTimeSheetInputModel
import com.oneswitch.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.oneswitch.features.viewAllOrder.model.AddOrderInputParamsModel
import com.oneswitch.features.viewAllOrder.model.AddOrderInputProductList
import com.oneswitch.mappackage.SendBrod
import com.oneswitch.widgets.AppCustomTextView
import com.oneswitch.MonitorService
import com.oneswitch.features.addshop.model.*
import com.oneswitch.features.addshop.model.assigntopplist.AddShopUploadImg
import com.oneswitch.features.login.api.LoginRepositoryProvider
import com.oneswitch.features.login.model.GetConcurrentUserResponse
import com.oneswitch.features.returnsOrder.ReturnProductList
import com.oneswitch.features.returnsOrder.ReturnRequest
import com.oneswitch.features.viewAllOrder.model.NewOrderSaveApiModel
  ...
  /*private fun callLogshareApi(){
    ...
    private fun callLogshareApi(){
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xoneswitchlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xoneswitchlogsample/log.zip").path))).use { out ->
                ...
                val addReqData = AddLogReqData()
                addReqData.user_id = Pref.user_id
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xoneswitchlogsample/log.zip").path);
                val file = File(fileUrl.path)
                if (!file.exists()) {
                    checkToCallActivity()
                }
